...
SELECT
    partition as name,
    date_trunc('month',lower(dtrange)) as sdate,
    date_trunc('month', upper(dtrange)) + '1 month'::interval as edate
    FROM partitions WHERE dtrange IS NOT NULL AND dtrange != 'empty'::tstzrange
