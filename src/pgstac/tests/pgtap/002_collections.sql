...
SELECT has_function('pgstac'::name, 'create_collection', ARRAY['jsonb', 'text', 'text[]']);
SELECT has_function('pgstac'::name, 'update_collection', ARRAY['jsonb', 'text', 'text[]']);
SELECT has_function('pgstac'::name, 'upsert_collection', ARRAY['jsonb', 'text', 'text[]']);
