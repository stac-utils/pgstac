...
SELECT collection, partition_dtrange, constraint_dtrange, constraint_edtrange, dtrange, edtrange FROM partitions WHERE collection='pgstactest-partitioned-oddballs' ORDER BY partition_dtrange;
