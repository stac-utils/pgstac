BEGIN;
ALTER SCHEMA pgstac RENAME TO pgstac045;
...
GRANT USAGE ON SCHEMA pgstac045 TO pgstac_admin;
GRANT SELECT ON ALL TABLES IN SCHEMA pgstac045 TO pgstac_admin;
GRANT USAGE ON ALL SEQUENCES IN SCHEMA pgstac045 TO pgstac_admin;
GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA pgstac045 TO pgstac_admin;
...
INSERT INTO collections (content) SELECT content FROM pgstac045.collections;
INSERT INTO items_staging SELECT content FROM pgstac045.items ORDER BY datetime ASC;
COMMIT;
